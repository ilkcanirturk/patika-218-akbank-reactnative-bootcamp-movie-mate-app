...
const ProfileScreen = () => {
  ...
  return (
    <View style={[styles.container, {backgroundColor: theme.backgroundColor}]}>
      ...
      <Text style={[styles.textName, {color: theme.color}]}>WhiteWolf</Text>
      <View style= {styles.containerInfo}>
        <Text style= {[styles.textInfo, {color: theme.color}]}>
            geraltofrivia@kaermorhen.com
        </Text>
      </View>
      <View style={styles.editContainer}>
      {/* Navigates when press */}
      <Pressable onPress={() => navigate('EditScreen')} style={styles.editButtonStyle}>
      ...
      <Pressable onPress={() => navigate('SignInScreen')} style={styles.logoutButtonStyle}>
